...
public class CryptoUtils {
    ...
    private static final String SECRET_KEY_1 = "-u-QY&aeYWSkM$9w";
    ...
    public CryptoUtils() throws UnsupportedEncodingException, NoSuchPaddingException, NoSuchAlgorithmException {
